let mapPlayer;_58a‍.x([["mapLeagues",()=>mapLeagues],["mapPlayers",()=>mapPlayers],["mapWeeks",()=>mapWeeks],["mapStatCategories",()=>mapStatCategories],["mapPositionTypes",()=>mapPositionTypes],["mapRosterPositions",()=>mapRosterPositions],["parseCollection",()=>parseCollection]]);_58a‍.w("./playerHelper.mjs",[["mapPlayer",["mapPlayer"],function(v){mapPlayer=v}]]);
  ...
  return players.reduce((result, p) => {
    if (p.player) {
      result.push(_58a‍.a("mapPlayer",mapPlayer)(p.player[0], p.player[1]));
    }
