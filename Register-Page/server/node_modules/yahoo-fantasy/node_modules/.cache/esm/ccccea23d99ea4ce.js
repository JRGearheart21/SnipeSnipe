let mapPlayer,mergeObjects,flattenObject,mapPlayers;_d99‍.x([["mapTeam",()=>mapTeam],["mapRoster",()=>mapRoster],["mapStats",()=>mapStats],["mapDraft",()=>mapDraft],["mapMatchups",()=>mapMatchups],["mapTeamPoints",()=>mapTeamPoints],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection],["parseGameCollection",()=>parseGameCollection]]);_d99‍.w("./playerHelper.mjs",[["mapPlayer",["mapPlayer"],function(v){mapPlayer=v}]]);_d99‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}],["flattenObject",["flattenObject"],function(v){flattenObject=v}]]);_d99‍.w("./gameHelper.mjs",[["mapPlayers",["mapPlayers"],function(v){mapPlayers=v}]]);



       function mapTeam(t) {
  const team = _d99‍.a("mergeObjects",mergeObjects)(t);
  // clean up team_logos
  ...
  return _d99‍.a("mapPlayers",mapPlayers)(players);
}
  ...
  return matchups;
       ...
       function mapTeamPoints(team, points) {
  ...
  return team;
       ...
       function parseCollection(ts, subresources) {
  ...
  return teams.map(t => {
    ...
    return team;
       ...
       function parseLeagueCollection(ls, subresources) {
  ...
  return leagues.map(l => {
    ...
    return league;
       ...
       function parseTeamCollection(ts, subresources) {
  const count = ts.count;
  const teams = [];
  ...
  return teams.map(t => {
    ...
    return team;
       ...
       function parseGameCollection(gs, subresources) {
