let mergeObjects,mapTeam;_58a‍.x([["mapPlayer",()=>mapPlayer],["mapStats",()=>mapStats],["mapPoints",()=>mapPoints],["mapOwnership",()=>mapOwnership],["mapDraftAnalysis",()=>mapDraftAnalysis],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection]]);_58a‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}]]);_58a‍.w("./teamHelper.mjs",[["mapTeam",["mapTeam"],function(v){mapTeam=v}]]);


       function mapPlayer(p, po) {
  const player = _58a‍.a("mergeObjects",mergeObjects)(p);
  ...
  return _58a‍.a("mergeObjects",mergeObjects)(da);
}
  ...
  return teams.map(t => {
    let team = _58a‍.a("mapTeam",mapTeam)(t.team[0]);
