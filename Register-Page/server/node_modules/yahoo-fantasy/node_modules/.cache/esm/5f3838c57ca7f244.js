let mapTeam,mapTeamPoints,mapTransactionPlayers;_7ca‍.x([["mapTeams",()=>mapTeams],["mapStandings",()=>mapStandings],["mapSettings",()=>mapSettings],["mapDraft",()=>mapDraft],["mapScoreboard",()=>mapScoreboard],["mapTransactions",()=>mapTransactions],["parseCollection",()=>parseCollection]]);_7ca‍.w("./teamHelper.mjs",[["mapTeam",["mapTeam"],function(v){mapTeam=v}],["mapTeamPoints",["mapTeamPoints"],function(v){mapTeamPoints=v}]]);_7ca‍.w("./transactionHelper.mjs",[["mapTransactionPlayers",["mapTransactionPlayers"],function(v){mapTransactionPlayers=v}]]);


/*
 * Helper function to map data to a "team"
 */
       function mapTeams(ts) {
  ...
  return transactions;
       ...
       function parseCollection(ls, subresources) {
