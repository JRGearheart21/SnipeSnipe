let mapSettings,mapStandings,mapScoreboard,mapTeams,mapDraft,mapTransactions,mapPlayers,extractCallback;_ba8‍.x([["default",()=>_ba8‍.o]]);_ba8‍.w("../helpers/leagueHelper.mjs",[["mapSettings",["mapSettings"],function(v){mapSettings=v}],["mapStandings",["mapStandings"],function(v){mapStandings=v}],["mapScoreboard",["mapScoreboard"],function(v){mapScoreboard=v}],["mapTeams",["mapTeams"],function(v){mapTeams=v}],["mapDraft",["mapDraft"],function(v){mapDraft=v}],["mapTransactions",["mapTransactions"],function(v){mapTransactions=v}]]);_ba8‍.w("../helpers/gameHelper.mjs",[["mapPlayers",["mapPlayers"],function(v){mapPlayers=v}]]);_ba8‍.w("../helpers/argsParser.mjs",[["extractCallback",["extractCallback"],function(v){extractCallback=v}]]);
...
class LeagueResource {
  ...
  transactions(leagueKey, cb = () => {}) {
    var league_key1 = leagueKey.toString().split(".t.")[0] //JRG

    return this.yf
      .api(
        this.yf.GET,
        //`https://fantasysports.yahooapis.com/fantasy/v2/league/${leagueKey}/transactions` JRG commented
       // `https://fantasysports.yahooapis.com/fantasy/v2/league/${leagueKey}/transactions;type=trade` //works

        `https://fantasysports.yahooapis.com/fantasy/v2/league/${league_key1}/transactions;team_key=${leagueKey};type=waiver`
  ...
  playersJRG(leagueKey,startVAL) {
    var league_key1 = leagueKey.toString().split(".t.")[0]
    
    let url = `https://fantasysports.yahooapis.com/fantasy/v2/league/${league_key1}/players;status=W;start=${startVAL};sort=PTS`;
