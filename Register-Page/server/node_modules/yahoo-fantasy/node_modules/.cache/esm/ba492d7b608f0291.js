let mergeObjects,mapTeam;_608‍.x([["mapPlayer",()=>mapPlayer],["mapStats",()=>mapStats],["mapPoints",()=>mapPoints],["mapOwnership",()=>mapOwnership],["mapDraftAnalysis",()=>mapDraftAnalysis],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection]]);_608‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}]]);_608‍.w("./teamHelper.mjs",[["mapTeam",["mapTeam"],function(v){mapTeam=v}]]);


       function mapPlayer(p, po) {
  const player = _608‍.a("mergeObjects",mergeObjects)(p);
  ...
  return _608‍.a("mergeObjects",mergeObjects)(da);
}
  ...
  return teams.map(t => {
    let team = _608‍.a("mapTeam",mapTeam)(t.team[0]);
