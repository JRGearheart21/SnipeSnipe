let mergeObjects,mapTeam;_592‍.x([["mapPlayer",()=>mapPlayer],["mapStats",()=>mapStats],["mapPoints",()=>mapPoints],["mapOwnership",()=>mapOwnership],["mapDraftAnalysis",()=>mapDraftAnalysis],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection]]);_592‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}]]);_592‍.w("./teamHelper.mjs",[["mapTeam",["mapTeam"],function(v){mapTeam=v}]]);


       function mapPlayer(p, po) {
  const player = _592‍.a("mergeObjects",mergeObjects)(p);
  ...
  return _592‍.a("mergeObjects",mergeObjects)(da);
}
  ...
  return teams.map(t => {
    let team = _592‍.a("mapTeam",mapTeam)(t.team[0]);
