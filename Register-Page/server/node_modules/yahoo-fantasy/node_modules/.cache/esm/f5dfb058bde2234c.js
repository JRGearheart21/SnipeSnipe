let https,stringify,crypto,oauthSignature,Game,League,Player,Roster,Team,Transaction,User,Games,Leagues,Players,Teams,Transactions;_bde‍.x([["default",()=>_bde‍.o]]);_bde‍.w("https",[["default",["https"],function(v){https=v}]]);_bde‍.w("querystring",[["stringify",["stringify"],function(v){stringify=v}]]);_bde‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);_bde‍.w("oauth-signature",[["default",["oauthSignature"],function(v){oauthSignature=v}]]);_bde‍.w("./resources/index.mjs",[["Game",["Game"],function(v){Game=v}],["League",["League"],function(v){League=v}],["Player",["Player"],function(v){Player=v}],["Roster",["Roster"],function(v){Roster=v}],["Team",["Team"],function(v){Team=v}],["Transaction",["Transaction"],function(v){Transaction=v}],["User",["User"],function(v){User=v}]]);_bde‍.w("./collections/index.mjs",[["Games",["Games"],function(v){Games=v}],["Leagues",["Leagues"],function(v){Leagues=v}],["Players",["Players"],function(v){Players=v}],["Teams",["Teams"],function(v){Teams=v}],["Transactions",["Transactions"],function(v){Transactions=v}]]);/* global module, require */
