let mergeObjects,mapTeam;_369‍.x([["mapPlayer",()=>mapPlayer],["mapStats",()=>mapStats],["mapPoints",()=>mapPoints],["mapOwnership",()=>mapOwnership],["mapDraftAnalysis",()=>mapDraftAnalysis],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection]]);_369‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}]]);_369‍.w("./teamHelper.mjs",[["mapTeam",["mapTeam"],function(v){mapTeam=v}]]);


       function mapPlayer(p, po) {
  const player = _369‍.a("mergeObjects",mergeObjects)(p);
  ...
  return _369‍.a("mergeObjects",mergeObjects)(da);
}
  ...
  return teams.map(t => {
    let team = _369‍.a("mapTeam",mapTeam)(t.team[0]);
