let mapSettings,mapStandings,mapScoreboard,mapTeams,mapDraft,mapTransactions,mapPlayers,extractCallback;_8f2‍.x([["default",()=>_8f2‍.o]]);_8f2‍.w("../helpers/leagueHelper.mjs",[["mapSettings",["mapSettings"],function(v){mapSettings=v}],["mapStandings",["mapStandings"],function(v){mapStandings=v}],["mapScoreboard",["mapScoreboard"],function(v){mapScoreboard=v}],["mapTeams",["mapTeams"],function(v){mapTeams=v}],["mapDraft",["mapDraft"],function(v){mapDraft=v}],["mapTransactions",["mapTransactions"],function(v){mapTransactions=v}]]);_8f2‍.w("../helpers/gameHelper.mjs",[["mapPlayers",["mapPlayers"],function(v){mapPlayers=v}]]);_8f2‍.w("../helpers/argsParser.mjs",[["extractCallback",["extractCallback"],function(v){extractCallback=v}]]);
...
class LeagueResource {
  ...
  transactions(leagueKey, cb = () => {}) {
    ...
    return this.yf
      .api(
        this.yf.GET,
        `https://fantasysports.yahooapis.com/fantasy/v2/league/${league_key1}/transactions;` //JRG commented
  ...
  transactions2(leagueKey, cb = () => {}) {
    var league_key1 = leagueKey.toString().split(".t.")[0] //JRG
    return this.yf
      .api(
        this.yf.GET,
        `https://fantasysports.yahooapis.com/fantasy/v2/league/${league_key1}/transactions;team_key=${leagueKey};type=waiver;status=pending;`
