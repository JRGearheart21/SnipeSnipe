let mapPlayer;_af8‍.x([["mapLeagues",()=>mapLeagues],["mapPlayers",()=>mapPlayers],["mapWeeks",()=>mapWeeks],["mapStatCategories",()=>mapStatCategories],["mapPositionTypes",()=>mapPositionTypes],["mapRosterPositions",()=>mapRosterPositions],["parseCollection",()=>parseCollection]]);_af8‍.w("./playerHelper.mjs",[["mapPlayer",["mapPlayer"],function(v){mapPlayer=v}]]);
  ...
  return players.reduce((result, p) => {
    if (p.player) {
      result.push(_af8‍.a("mapPlayer",mapPlayer)(p.player[0], p.player[1]));
    }
