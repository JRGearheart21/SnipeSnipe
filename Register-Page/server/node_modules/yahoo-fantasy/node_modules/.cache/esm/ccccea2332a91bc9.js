let mapPlayer,mergeObjects,flattenObject,mapPlayers;_32a‍.x([["mapTeam",()=>mapTeam],["mapRoster",()=>mapRoster],["mapStats",()=>mapStats],["mapDraft",()=>mapDraft],["mapMatchups",()=>mapMatchups],["mapTeamPoints",()=>mapTeamPoints],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection],["parseGameCollection",()=>parseGameCollection]]);_32a‍.w("./playerHelper.mjs",[["mapPlayer",["mapPlayer"],function(v){mapPlayer=v}]]);_32a‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}],["flattenObject",["flattenObject"],function(v){flattenObject=v}]]);_32a‍.w("./gameHelper.mjs",[["mapPlayers",["mapPlayers"],function(v){mapPlayers=v}]]);



       function mapTeam(t) {
  const team = _32a‍.a("mergeObjects",mergeObjects)(t);
  // clean up team_logos
  ...
  return _32a‍.a("mapPlayers",mapPlayers)(players);
}
