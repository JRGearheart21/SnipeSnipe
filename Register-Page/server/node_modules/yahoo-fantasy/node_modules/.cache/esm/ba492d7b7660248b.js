let mergeObjects,mapTeam;_766‍.x([["mapPlayer",()=>mapPlayer],["mapStats",()=>mapStats],["mapPoints",()=>mapPoints],["mapOwnership",()=>mapOwnership],["mapDraftAnalysis",()=>mapDraftAnalysis],["parseCollection",()=>parseCollection],["parseLeagueCollection",()=>parseLeagueCollection],["parseTeamCollection",()=>parseTeamCollection]]);_766‍.w("./sharedHelpers.mjs",[["mergeObjects",["mergeObjects"],function(v){mergeObjects=v}]]);_766‍.w("./teamHelper.mjs",[["mapTeam",["mapTeam"],function(v){mapTeam=v}]]);


       function mapPlayer(p, po) {
  const player = _766‍.a("mergeObjects",mergeObjects)(p);
  ...
  return {
    ...
    total: points.total
       ...
       function mapOwnership(ownership) {
  const o = {
  ...
  return o;
       ...
       function mapDraftAnalysis(da) {
  return _766‍.a("mergeObjects",mergeObjects)(da);
}

       function parseCollection(ps, subresources) {
  ...
  return teams.map(t => {
    let team = _766‍.a("mapTeam",mapTeam)(t.team[0]);
